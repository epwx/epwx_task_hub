...
const flow = [
  ...
  },
  {
    ...
    owner: "Customer",
    screenshotSrc: "/blog/merchant-code-flow-04-customer.png",
    screenshotAlt: "EPWX merchant claim form with purchase code, email address, notification consent, and fixed reward button",
    screenshotWidth: 768,
    screenshotHeight: 1152,
    screenshotCaption: "After connecting a wallet, the customer enters the purchase code and email, then confirms notification consent.",
  },
  {
    number: "05",
