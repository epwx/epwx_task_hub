      ...
      <div className="max-w-2xl mx-auto py-12 px-4">
        ...
        <ol className="list-decimal pl-6 space-y-6 text-lg">
          ...
          <li>
            ...
            <ul className="list-disc pl-6">
              <li>The <b>Cashback Rewards</b> section allows you to claim a fixed <b>1,000,000 EPWX</b> cashback reward for eligible purchases above <b>1,000,000,000 EPWX</b> made within the last 3 hours.</li>
