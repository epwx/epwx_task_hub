...
type TabIcon = "home" | "tasks" | "cashback" | "referrals" | "buy" | "stats";
...
const PRIMARY_TAB_ITEMS: Array<{ href: string; label: string; icon: TabIcon }> = [
...
export default function MobileTabBar() {
  ...
  const finalTab = pathname.startsWith("/buy-epwx")
    ? { href: "/platform-stats", label: "Stats", icon: "stats" as const }
    : { href: "/buy-epwx", label: "Buy", icon: "buy" as const };
  const tabItems = [...PRIMARY_TAB_ITEMS, finalTab];
