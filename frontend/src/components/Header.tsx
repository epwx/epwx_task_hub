...
export default function Header({ darkMode, setDarkMode }: HeaderProps) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 max-w-full overflow-x-clip border-b border-slate-200/80 bg-white/88 shadow-[0_10px_35px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/85">
            ...
            <div className="flex items-center gap-2">
              ...
              {isAdmin ? (
                <details ref={adminMenuRef} open={adminMenuOpen} className="group relative">
                  ...
                  <div className="absolute right-0 top-full z-20 mt-2 w-56 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl dark:border-slate-700 dark:bg-slate-900">
